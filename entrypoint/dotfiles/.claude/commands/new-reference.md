---
description: Scaffold a new reference document at tasks/reference/<slug>.md in the current repo
...
`~/.claude/CLAUDE.md` for what qualifies and how these differ from task docs.
...
5. If `tasks/reference/$ARGUMENTS.md` already exists, stop and tell me — show me what it covers and ask whether I want to update the existing note instead of clobbering it. Do not overwrite. (Reference docs are updated in place, never archived.)
6. Otherwise, create `tasks/reference/$ARGUMENTS.md` with this skeleton:
