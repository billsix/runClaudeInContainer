" Baked default .vimrc for the runClaudeInContainer sandbox (entrypoint/dotfiles/.vimrc).
" Shadowed by the host's ~/.vimrc when `make shell` finds one (VIMRC_MOUNT in the Makefile),
